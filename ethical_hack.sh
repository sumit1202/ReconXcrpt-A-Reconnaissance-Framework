...
echo "Option 18 : dnsenum"
echo "Option 19 : smbclient"
echo "Option 20 : nbtscan"
echo "Option 21 : Wanna Quit"
...
options=("Option 1" "Option 2" "Option 3" "Option 4" "Option 5" "Option 6" "Option 7" "Option 8" "Option 9" "Option 10" "Option 11" "Option 12" "Option 13" "Option 14" "Option 15" "Option 16" "Option 17" "Option 18" "Option 19" "Option 20" "Quit")
...
"Option 19")
            ...
            target=192.168.1.9
            smbclient -L $target
            echo -e "\n\nCheck above for smbclient run-time output !!\n"
            #echo -e "\nWait please.....\n"
            #smbclient -L $target > /root/Desktop/bashscripts/$name/smbclient.txt
            #echo -e "\nMr/Mrs $name, you can check /root/Desktop/bashscripts/$name folder for output\n"
            echo -e "#############################################################################\n"
           ;;
